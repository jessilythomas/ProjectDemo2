...
$(document).ready(function(){
    $("form").submit(function(event){
        ...
        $.post("RegistrationFullPhp.php", formValues, function(data){
            $("#result").html(data);
        });
    });
});
...
<select id="country" width="20" class="form-control"  required="" autofocus="" data-rule-required="true" data-msg-required="plz enter country"  name="country">
...
?>
 ...
 <select id="state" class="form-control"  required="" autofocus="" data-rule-required="true" data-msg-required="plz enter state" data-rule-date="true" name="state">
    <option value="">Select country first</option>
</select>

</br>
<select id="city" class="form-control"  required="" autofocus="" data-rule-required="true" data-msg-required="plz enter city" data-rule-date="true" name="city">
...
<p id="msg"></p>
        <input type="file" id="file" name="file" data-rule-required="true" data-msg-required="plz select file" class="form-control"/>
       </br>
